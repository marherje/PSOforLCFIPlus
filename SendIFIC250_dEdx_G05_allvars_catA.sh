...
python runPSO.py -c config/FlavourTag250IFIC_dEdx_G05_allvars_configs/FlavourTag250IFIC_dEdx_catA.txt -o output/FlavourTag250IFIC_dEdx_G05_allvars_catA > log/LogFlavourTag250IFIC_dEdx_G05_allvars_catA.log	
